  ...
  Future<void> _save() async {
    ...
    if (phone.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Wpisz numer telefonu'),
    ...
    if (phone.length < 9) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Numer telefonu musi mieć minimum 9 cyfr'),
          backgroundColor: Colors.red,
        ),
      );
      return;
    ...
    if (provider.isWorking || provider.isOnBreak) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Nie można zmienić numeru w trakcie pracy!'),
          backgroundColor: Colors.red,
        ),
      );
      return;
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Numer zapisany: $phone'),
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Wpisz swój numer — służy jako identyfikator w systemie.',
              ...
              Container(
                ...
                child: const Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Numer zapamiętany. Możesz startować pracę.',
